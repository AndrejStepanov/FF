		...
		computed: {
			...
			inputs() {
				...
				return [
					...
					{id:13, form:'object-tree-add',	code:'m_tree_dates',		name:'Даты', 			placeholder:'Даты объекта', 				type:'DATE', 		value_arr:['2018-10-03'],			multy:true,		nullable:false, column_size:30, sort_seq:2, },

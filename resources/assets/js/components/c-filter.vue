		...
		computed:{
			inputs() {
				...
				return [
					...
					{id:'2', 	form:'object-tree-add',	code:'obj_param',					name:'Параметр', 				placeholder:'Ввод параметров', 				type:'INPUT', 							nullable:false,	sort_seq:2, tab_header, tab_values, tab_group:'obj_param', withTab:true , isAuto:true																																	},

		...
		computed:{
			inputs() {
				...
				return [
					...
					{id:'5', 	form:'object-tree-add',	code:'tree_num',					name:'Текст', 					placeholder:'Ввод текста', 					type:'NUMBER', 				value:"ыва",												multy:false,	nullable:false, column_size:30, sort_seq:5, },
					{id:'6', 	form:'object-tree-add',	code:'tree_int', 					name:'Название',				placeholder:'Описание объекта', 			type:'NUMBER',				value:"10",													multy:false,	nullable:true, 	column_size:30, sort_seq:6, min:0,},

<template>
	<div  style="display: contents;">
		<v-toolbar-title class="text-xs-center check-size flex--inherit">{{ $vuetify.lang.t('$vuetify.texts.simple.labels.filter') }} </v-toolbar-title> 
		...
		computed:{
			inputs() {
				...
				return [
					...
					{id:8, form:'object-tree-add',	code:'obj_level', 					name:'Вложенность', 			placeholder:'Уровень вложенности объекта', 	type:'LIST',				value_arr:["cur"],											multy:false,	nullable:false, column_size:30, sort_seq:8, table_values:[{value:'cur',text:'Текущий уровень'},{value:'inside',text:'Вложенный'},{value:'strange',text:'Странный'},]  },
					{id:9, form:'object-tree-add',	code:'m_tree_line',					name:'Информация', 										 					type:'LINE', 																															sort_seq:9, },
					{id:10, form:'object-tree-add',	code:'tree_group',					name:'Тип', 					placeholder:'Тип объекта', 					type:'LIST', 				value_arr:["node"],											multy:false,	nullable:false, column_size:30, sort_seq:10, table_values:[{value:'node',text:'Узел дерева'},{value:'ARM',text:'Рабочая область'},{value:'filter',text:'Фильтр'},{value:'input',text:'Поле ввода'},]  },
					{id:11, form:'object-tree-add',	code:'tree_range', 					name:'Значение',				placeholder:'Описание диапазона',			type:'RANGE',				value_arr:[[22,30]],										multy:false,	nullable:false, column_size:30, sort_seq:11, min:10, max:100 },
					...
					{id:13, form:'object-tree-add',	code:'obj_level1', 					name:'Вложенность1', 			placeholder:'Уровень вложенности объекта', 	type:'RANGE',				value_arr:[[0,1]],											multy:false,	nullable:false, column_size:30, sort_seq:13, table_values:[{value:'cur',text:'Текущий уровень'},{value:'inside',text:'Вложенный'},{value:'strange',text:'Странный'},]  },
					...
					{id:15, form:'object-tree-add',	code:'tree_group1',					name:'Тип1', 					placeholder:'Тип объекта', 					type:'SLIDER', 				value:"1",													multy:false,	nullable:false, column_size:30, sort_seq:15, table_values:[{value:'node',text:'Узел'},{value:'ARM',text:'Область'},{value:'filter',text:'Фильтр'},{value:'input',text:'Поле'},]  },
					...
					{id:23, form:'object-tree-add',	code:'m_tree_datetime',				name:'Дата Время', 				placeholder:'Дата Время объекта', 			type:'DATETIME', 			value_arr:["2018-10-03 12:52"],								multy:false,	nullable:false, column_size:30, sort_seq:23, },
					...
					{id:26, form:'object-tree-add',	code:'m_tree_datetime_range',		name:'Дата Время диапазон', 	placeholder:'Дата Время объекта', 			type:'DATETIME_RANGE', 		value_arr:[["2018-10-03 12:52","2018-10-04 12:53"]],		multy:false,	nullable:false, column_size:30, sort_seq:26, },
				/**/	
				]
			},
		},

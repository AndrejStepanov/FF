		...
		computed:{
			inputs() {
				...
				return [
					...
					{id:'2', 	form:'object-tree-add',	code:'obj_param',					name:'Параметр', 				placeholder:'Ввод параметров', 				type:'TAB', 				value:null,													multy:false,	nullable:false, column_size:30, sort_seq:2, tab_header, tab_values, tab_group:'obj_param' , isAuto:true},
					...
					{id:'16', 	form:'object-tree-add',	code:'m_obj_level2', 				name:'Вложенность', 			placeholder:'Уровень вложенности объекта', 	type:'LIST',				value:"cur",												multy:true,		nullable:false, column_size:30, sort_seq:16, table_values:[{value:'cur',text:'На текущем этом прям прям этом уровне'},{value:'inside',text:'Вложенный'},{value:'strange',text:'Странный'},],   },	
					{id:'17', 	form:'object-tree-add',	code:'m_obj_level', 				name:'Вложенность', 			placeholder:'Уровень вложенности объекта', 	type:'LIST',				value:"cur",												multy:true,		nullable:false, column_size:30, sort_seq:17, table_values:[{value:'cur',text:'Текущий уровень'},{value:'inside',text:'Вложенный'},{value:'strange',text:'Странный'},]  },

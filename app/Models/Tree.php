...
class Tree extends Model{
	protected $table = 'trees'; //лара автоматом добавляет в конец названия класа 's' и ищет таблицу с таким названием. 
    /**
    ...
    protected $fillable = [
		'tree_id','tree_group', 'parent_id', 'parent_ids', 'level', 'tree_name', 'tree_desc', 'tree_path', 'seq_num', 
    ];

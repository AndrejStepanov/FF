...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6d105e4a", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d105e4a", Component.options)
  } else {
    hotAPI.reload("data-v-6d105e4a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })

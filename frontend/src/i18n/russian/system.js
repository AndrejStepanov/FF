export default {
	...
	//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			modals:{
				...
				addRecord:		{	title:'Добавление записи',},
				editRecord:		{	title:'Редактирование записи',},
				deleteRecord:	{	title:'Удаление записи', quest:'Вы уверены что хотите удалить выбранные записи?'},
			},
			//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			actions:{
				add:'Добавить',
			...
			errors:{
				...
				dialogInitNoParam:		{	title:'Ошибка инициализации окна', 					text:'Не указан параметр <b>{0}</b>!',},
				dialogInitWrongName:	{	title:'Ошибка инициализации окна', 					text:'Указан не существующий идентификатор диалога <b>{0}</b> - <b>{1}</b>!',},
				dialogInitDouble:		{	title:'Ошибка инициализации окна', 					text:'Повторная инициализация окна <b>{0}</b>  <b>{1}</b>!',},
				fieldsInitWrongParam:	{	title:'Ошибка инициализации полей ввода', 			text:'Указано неверно значения для параметра  <b>{0}</b> - <b>{1}</b>!',},				
				paramsInitInvalidParam:	{	title:'Ошибка при формировании полей ввода', 		text:'Указан несуществующий набор параметров  <b>{0}</b> - <b>{1}</b>!',},				
				paramsConfInvalidType:	{	title:'Ошибка загрузки полей ввода', 				text:'Неизвестный тип полей ввода <b>{0}</b> !',},
				...
				wrongDateInput:	 		{	title:'Ошибка при вводе даты',						text:'Некорректная дата - {0}!',},
				wrongTimeInput:	 		{	title:'Ошибка при вводе времени',					text:'Некорректное время - {0}!',},
				...
				wrongTableParam:	 	{	title:'Ошибка в настройках таблицы',				text:'Для таблицы <b>{0}</b> некорректно задан параметр <b>{1}</b> : <b>{2}</b>!',},
				valNeedMore:			{	title:'Неверное значение', 							text:'Значение должно быть не меньше {0}!',},
				valNeedLess: 			{	title:'Неверное значение', 							text:'Значение не должно превышать {0}!',},
				valNeedLessLength: 		{	title:'Неверное значение', 							text:'Количество символов не должно превышать {0} Символов!',},
				fieldIsNecessary: 		{	title:'Неверное значение', 							text:'Поле обязательное!',},
				fieldMustUsed:			{	title:'Неверное значение', 							text:'Поле должно быть использовано!',},
				authNeed: 				{	title:'Ошибка авторизации', 						text:'Необходимо авторизоваться!',},
				dateForamatWrong: 		{	title:'Неверное значение', 							text:'Некорректный формат дат/времени!',},
				needLogin: 				{	title:'Проверка прав доступа', 						text:'Для доступа к этой странице, необходимо авторизироваться в системе!',},
				noAccess: 				{	title:'Проверка прав доступа', 						text:'У вас недостаточно прав для просмотра данной страницы!',},
				invalidHref: 			{	title:'Нет доступа', 								text:'Указан некорректный адрес страницы или у вас нет к ней доступа!',},
			},
			msgs:{
				...
				defTextMes: 			{	title:'Текст', 										text:'Текст сообщения',},
				isLoading: 				{	title:'Идет загрузка', 								text:'Подождите, идет загрузка!',},			
			},
			//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		},	
	},

	...
	export default {
		computed: {
			...
			... mapGetters( {//перечень функций из стандартных vuex
				...
				pageButtonByPage:"pageButton/getByPage",
				pageButtonDisable:"pageButton/getDisable",
		...
		methods: {
			... mapActions({
				...
				pageButtonInit:"pageButton/doInit",
				pageButtonAdd:"pageButton/doAdd",
				pageButtonEdit:"pageButton/doEdit",
				pageButtonSetDisable:"pageButton/doSetDisable",
